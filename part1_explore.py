...
def task1_visualize_input(building_ids, n=4):
    ...
    fig.suptitle("Input data: domain and interior masks", fontsize=14)
    ...
    plt.colorbar(im, ax=axes[0, :], label='Temperature (°C)', shrink=0.6)
    plt.tight_layout()
...
def task3_visualize_results(building_ids, n=4):
    ...
    for idx in range(n):
        ...
        # Mask exterior points for clean visualisation
